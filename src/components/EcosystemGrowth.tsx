    ...
    <div className="ug-ecosystem-growth">
      <style>{`
        ...
        .ug-eg-summary-panel {
          ...
          border-radius: 26px;
          background:
            radial-gradient(900px 360px at 0% 0%, rgba(56,189,248,0.08), transparent 55%),
            radial-gradient(700px 300px at 100% 100%, rgba(168,85,247,0.08), transparent 55%),
        ...
        .ug-eg-summary-panel::before {
          content: ''; position: absolute; inset: 0;
          background: radial-gradient(600px 200px at 50% 0%, rgba(125,211,252,0.08), transparent);
          pointer-events: none;
        }
        .ug-eg-summary-table {
        ...
        .ug-eg-summary-table th {
          text-align: left; padding: 0 14px 8px;
          font-size: 10px; letter-spacing: 0.28em; text-transform: uppercase;
          color: #64748B; font-weight: 600; border-bottom: 1px solid rgba(255,255,255,0.08);
        }
        .ug-eg-summary-table th:nth-child(1) { width: 60px; text-align: center; }
        .ug-eg-summary-table th:nth-child(3) { width: 120px; text-align: center; }
        .ug-eg-summary-table td {
          padding: 16px 14px;
          background: rgba(255,255,255,0.025);
        ...
        .ug-eg-summary-table td:first-child { border-radius: 14px 0 0 14px; border-left: 1px solid rgba(255,255,255,0.06); }
        .ug-eg-summary-table td:last-child { border-radius: 0 14px 14px 0; border-right: 1px solid rgba(255,255,255,0.06); }
        .ug-eg-summary-table tr:nth-child(1) td { background: linear-gradient(90deg, rgba(251,191,36,0.10), rgba(255,255,255,0.03)); }
        .ug-eg-summary-table tr:nth-child(1) td:first-child { border-left: 1px solid rgba(251,191,36,0.35); }
        .ug-eg-summary-rank {
        ...
        .ug-eg-summary-table tr:nth-child(1) .ug-eg-summary-rank {
          background: linear-gradient(135deg, rgba(251,191,36,0.25), rgba(251,191,36,0.10));
          border-color: rgba(251,191,36,0.55); color: #FDE68A;
          box-shadow: 0 0 20px rgba(251,191,36,0.25);
        }
        .ug-eg-summary-layer {
          font-family: 'Poppins', sans-serif; font-weight: 600;
          font-size: clamp(0.92rem, 1.5vw, 1.05rem); color: #F1F5F9; letter-spacing: -0.005em;
        }
        .ug-eg-summary-strength {
          font-family: 'Poppins', sans-serif; font-weight: 700;
          font-size: 1.05rem; color: #F8FAFC; text-align: center;
        }
        .ug-eg-summary-reason {
          font-size: 0.84rem; color: #CBD5E1; line-height: 1.6; max-width: 420px;
        }
        .ug-eg-final-reality {
          display: grid; gap: 16px; grid-template-columns: 1fr;
          margin-top: clamp(28px, 4vw, 40px); position: relative; z-index: 1;
        }
        @media (min-width: 820px) {
          .ug-eg-final-reality { grid-template-columns: 1.3fr 1fr 1fr; }
        }
        .ug-eg-reality-card {
        ...
        .ug-eg-reality-card:hover { transform: translateY(-3px); border-color: rgba(255,255,255,0.18); }
        .ug-eg-reality-card.primary {
          background: linear-gradient(135deg, rgba(56,189,248,0.08), rgba(168,85,247,0.06));
          border: 1px solid rgba(125,211,252,0.25);
        }
        .ug-eg-reality-card.weaken { border-top: 3px solid rgba(251,113,133,0.65); }
        .ug-eg-reality-card.strengthen { border-top: 3px solid rgba(74,222,128,0.65); }
        .ug-eg-reality-label {
          font-size: 10px; letter-spacing: 0.28em; text-transform: uppercase;
          font-weight: 700; margin-bottom: 14px; color: #94A3B8;
        }
        .ug-eg-reality-card.primary .ug-eg-reality-label { color: #7DD3FC; }
        .ug-eg-reality-card.weaken .ug-eg-reality-label { color: #FDA4AF; }
        .ug-eg-reality-card.strengthen .ug-eg-reality-label { color: #86EFAC; }
        .ug-eg-reality-text {
        ...
        .ug-eg-reality-list li {
          display: flex; align-items: flex-start; gap: 10px;
          font-size: 0.82rem; color: #CBD5E1; line-height: 1.55;
        }
        .ug-eg-reality-list li::before {
          content: ''; flex: 0 0 5px; width: 5px; height: 5px; border-radius: 50%;
          margin-top: 7px; background: currentColor;
        }
        .ug-eg-reality-card.weaken .ug-eg-reality-list li { color: #FDA4AF; }
        .ug-eg-reality-card.strengthen .ug-eg-reality-list li { color: #86EFAC; }
        .ug-eg-reality-card.weaken .ug-eg-reality-list li::before { box-shadow: 0 0 8px rgba(251,113,133,0.55); }
        .ug-eg-reality-card.strengthen .ug-eg-reality-list li::before { box-shadow: 0 0 8px rgba(74,222,128,0.55); }
        @media (max-width: 640px) {
          .ug-eg-summary-table th:nth-child(4) { display: none; }
          .ug-eg-summary-table td:nth-child(4) { display: none; }
          .ug-eg-summary-table td { padding: 12px 10px; }
        }
      ...
      >
        ...
        <h2 className="ug-eg-section-title">10-Year Ecosystem Growth Analysis</h2>
        <p className="ug-eg-section-tag">
          Shows whether this career is likely to keep creating fresher opportunities over the next 10 years.
        </p>

        <table className="ug-eg-summary-table">
          <thead>
            <tr>
              <th>Rank</th>
              <th>Layer</th>
          ...
          <tbody>
            {rankedSummary.map((item) => (
              <motion.tr
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: item.rank * 0.08, ease: [0.34, 1.56, 0.64, 1] }}
              >
                <td>
                  <div className="ug-eg-summary-rank">{item.rank}</div>
                </td>
                <td>
                  <div className="ug-eg-summary-layer">{item.layer}</div>
                </td>
                <td>
                  <div className="ug-eg-summary-strength">{item.strength}/100</div>
                </td>
                <td>
                  <div className="ug-eg-summary-reason">{item.reason}</div>
                </td>
              </motion.tr>
            ))}
          </tbody>
        ...
        <div className="ug-eg-final-reality">
          <div className="ug-eg-reality-card primary">
            <div className="ug-eg-reality-label">Final Reality</div>
            <div className="ug-eg-reality-text">{finalReality.survival}</div>
          </div>
          <div className="ug-eg-reality-card weaken">
            <div className="ug-eg-reality-label">What Could Weaken It</div>
            <ul className="ug-eg-reality-list">
              {finalReality.weaken.map((w) => <li key={w}>{w}</li>)}
            </ul>
          </div>
          <div className="ug-eg-reality-card strengthen">
            <div className="ug-eg-reality-label">What Could Strengthen It</div>
            <ul className="ug-eg-reality-list">
              {finalReality.strengthen.map((s) => <li key={s}>{s}</li>)}
            </ul>
          </div>
        </div>
      </motion.div>
