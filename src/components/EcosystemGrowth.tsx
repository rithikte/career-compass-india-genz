  ...
  return (
    <div className="ug-ecosystem-growth">
      <style>{`
        ...
        /* ===== Redesigned Final Summary v2 — Editorial Leaderboard Chart ===== */
        ...
        .ug-eg-summary-scroll::-webkit-scrollbar-thumb {
          background: rgba(125,211,252,0.28); border-radius: 999px;
        }

        .ug-eg-summary-panel {
          position: relative;
          width: 1200px;              /* locked canvas — identical at every screen */
          padding: 48px 52px 52px;
          border-radius: 28px;
          background:
            radial-gradient(1000px 340px at 100% -10%, rgba(168,85,247,0.12), transparent 60%),
            radial-gradient(800px 320px at -10% 110%, rgba(56,189,248,0.12), transparent 60%),
        ...
        .ug-eg-summary-panel::before {
          ...
          background: linear-gradient(180deg, rgba(255,255,255,0.07), transparent 25%);
          mask: linear-gradient(#000, transparent 55%);
        }
        .ug-eg-summary-panel::after {
          content: ''; position: absolute; inset: 0; pointer-events: none; opacity: 0.35;
          background-image:
            linear-gradient(rgba(255,255,255,0.04) 1px, transparent 1px);
          background-size: 100% 68px;
          background-position: 0 130px;
          mask: linear-gradient(180deg, transparent 0, #000 20%, #000 78%, transparent 100%);
        }
        ...
        .ug-eg-chart-head {
          position: relative;
          display: grid;
          grid-template-columns: 92px minmax(0, 1fr) 380px minmax(0, 1.2fr);
          gap: 32px; align-items: end;
          padding: 0 4px 18px;
          margin-bottom: 22px;
          border-bottom: 1px solid rgba(255,255,255,0.10);
        }
        .ug-eg-chart-head-label {
        ...
        .ug-eg-chart-scale {
          ...
          font-weight: 700; color: rgba(203,213,225,0.5);
        }
        .ug-eg-chart-scale span:nth-child(2) { color: rgba(134,239,172,0.75); }
        ...
        .ug-eg-rank-item:last-child { border-bottom: none; }
        .ug-eg-rank-item:hover {
          background: linear-gradient(90deg, rgba(56,189,248,0.05), transparent 70%);
        }

        /* Oversized outline rank numeral */
        .ug-eg-rank-numeral {
          position: relative;
          font-family: 'Poppins', sans-serif; font-weight: 800;
          font-size: 4.2rem; line-height: 1; letter-spacing: -0.05em;
          color: transparent;
          -webkit-text-stroke: 1.5px rgba(203,213,225,0.35);
          background: linear-gradient(180deg, rgba(255,255,255,0.14), transparent);
          -webkit-background-clip: text; background-clip: text;
        }
        .ug-eg-rank-numeral::after {
          content: 'RANK';
          position: absolute; left: 2px; bottom: -6px;
          font-size: 8.5px; letter-spacing: 0.34em;
          -webkit-text-stroke: 0; color: rgba(203,213,225,0.5);
          font-weight: 700;
        }
        .ug-eg-rank-item[data-top="true"] .ug-eg-rank-numeral {
          -webkit-text-stroke: 1.5px rgba(251,191,36,0.75);
          background: linear-gradient(180deg, #FDE68A, rgba(251,191,36,0.15));
          -webkit-background-clip: text; background-clip: text;
          filter: drop-shadow(0 6px 20px rgba(251,191,36,0.35));
        }
        .ug-eg-rank-item[data-top="true"] .ug-eg-rank-numeral::after {
          color: #FCD34D;
        }

        .ug-eg-rank-layer-wrap { display: flex; flex-direction: column; gap: 6px; }
        .ug-eg-rank-layer {
          font-family: 'Poppins', sans-serif; font-weight: 600;
        ...
        .ug-eg-rank-item[data-top="true"] .ug-eg-rank-sub { color: #FCD34D; }
        .ug-eg-rank-item[data-top="true"] .ug-eg-rank-sub .dot {
          background: #FCD34D; box-shadow: 0 0 10px #FCD34D;
        }
        @keyframes eg-pulse {
        ...
        .ug-eg-gauge-track .seg {
          height: 100%; border-radius: 3px;
          background: rgba(255,255,255,0.05);
          border: 1px solid rgba(255,255,255,0.04);
          transition: background .3s ease, box-shadow .3s ease;
        }
        .ug-eg-gauge-track .seg.on {
          background: linear-gradient(180deg, #86EFAC, #34D399);
          border-color: rgba(52,211,153,0.55);
          box-shadow: 0 0 10px rgba(52,211,153,0.55), inset 0 1px 0 rgba(255,255,255,0.15);
        }
        .ug-eg-rank-item[data-top="true"] .ug-eg-gauge-track .seg.on {
          background: linear-gradient(180deg, #FDE68A, #F59E0B);
          border-color: rgba(251,191,36,0.6);
          box-shadow: 0 0 12px rgba(251,191,36,0.65), inset 0 1px 0 rgba(255,255,255,0.25);
        }
        .ug-eg-gauge-meta {
          display: flex; justify-content: space-between; align-items: center;
        ...
        .ug-eg-gauge-meta .label { color: rgba(203,213,225,0.55); }
        .ug-eg-gauge-meta .value {
          font-family: 'Poppins', sans-serif; font-size: 1.15rem; letter-spacing: -0.02em;
          color: #F8FAFC; text-transform: none; font-weight: 700;
        }
        .ug-eg-rank-item[data-top="true"] .ug-eg-gauge-meta .value { color: #FCD34D; }
        ...
        .ug-eg-rank-reason::before {
          content: ''; position: absolute; left: 0; top: 6px; bottom: 6px;
          width: 2px; border-radius: 2px;
          background: linear-gradient(180deg, rgba(125,211,252,0.55), rgba(168,85,247,0.35));
        }
        .ug-eg-rank-item[data-top="true"] .ug-eg-rank-reason::before {
          background: linear-gradient(180deg, #FCD34D, #F59E0B);
        }

        /* Pillars — connected 3-step sequence, always in one row */
        .ug-eg-pillars {
          position: relative;
          margin-top: 44px;
        ...
        .ug-eg-pillars::before {
          content: ''; position: absolute; left: 8%; right: 8%; top: 28px; height: 1px;
          background: linear-gradient(90deg, rgba(125,211,252,0.35), rgba(253,164,175,0.35), rgba(134,239,172,0.35));
        ...
        .ug-eg-pillar {
          ...
          border-radius: 20px;
          background:
            radial-gradient(400px 160px at 100% 0%, color-mix(in srgb, var(--pillar-color) 12%, transparent), transparent 60%),
            linear-gradient(180deg, rgba(255,255,255,0.045), rgba(255,255,255,0.012));
        ...
        .ug-eg-pillar:hover {
          ...
          box-shadow: 0 26px 55px -30px color-mix(in srgb, var(--pillar-color) 65%, transparent);
        }
        .ug-eg-pillar-step {
          position: relative;
          display: inline-flex; align-items: center; justify-content: center;
          ...
          background: color-mix(in srgb, var(--pillar-color) 12%, rgba(255,255,255,0.02));
          border: 1px solid color-mix(in srgb, var(--pillar-color) 40%, transparent);
          box-shadow: 0 8px 22px -12px color-mix(in srgb, var(--pillar-color) 55%, transparent);
          margin-bottom: 16px;
        }
        .ug-eg-pillar-step::after {
          content: ''; position: absolute; inset: -6px; border-radius: 16px;
          border: 1px dashed color-mix(in srgb, var(--pillar-color) 30%, transparent);
          opacity: 0.6;
        }
        .ug-eg-pillar-tag {
          display: inline-flex; align-items: center; gap: 8px;
        ...
        .ug-eg-pillar-title {
          font-family: 'Poppins', sans-serif; font-weight: 600;
          font-size: 1.1rem; color: #F8FAFC; line-height: 1.35;
          margin-bottom: 12px; letter-spacing: -0.01em;
        }
        .ug-eg-pillar-text {
          font-size: 0.9rem; color: #CBD5E1; line-height: 1.7;
        }
